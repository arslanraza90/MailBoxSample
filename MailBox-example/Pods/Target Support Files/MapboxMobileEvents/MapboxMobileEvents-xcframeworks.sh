...
install_xcframework "${PODS_ROOT}/MapboxMobileEvents/MapboxMobileEvents.xcframework" "MapboxMobileEvents" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7" "ios-arm64_x86_64-maccatalyst"
